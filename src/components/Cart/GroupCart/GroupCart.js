  ...
  return (
    <S.GroupCart>
      <S.CartContainer>
        ...
        {cartData.map(
          ({ id, thumbnail, productName, delivery, color, price }) => (
            <S.CartList key={id}>
              <S.CartArticle>
                    ...
                    <S.CartProduct>
                      ...
                      <S.CartSmallProduct>
                        ...
                        <S.CartProductContents>
                          <S.CartProductTitle>{productName}</S.CartProductTitle>
                          <S.CartProductDeliver>
                            {delivery}
                          </S.CartProductDeliver>
                      ...
                      <S.CartCountWrap>
                        <S.CartCountArticle>
                          <S.CartCountBox>
                            <CartCount /> {/* count button 자리 */}
                            <S.CartPriceWrap>
                              <S.CartPrice>{price} 원</S.CartPrice>
                            </S.CartPriceWrap>
                          </S.CartCountBox>
                        </S.CartCountArticle>
                      </S.CartCountWrap>
